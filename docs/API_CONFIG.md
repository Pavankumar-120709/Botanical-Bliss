...
This document explains the centralized API configuration system implemented in Botanical Bliss.
...
**File**: `botanical-bliss-ui/src/config/api.js`
...
**File**: `botanical-bliss-ui/src/config/index.js`
...
export const ENV = {
  ...
  APP_NAME: import.meta.env.VITE_APP_NAME || 'Botanical Bliss',
  // ...
};
```
...
1. **Edit ONE file**: `botanical-bliss-ui/src/config/api.js`
   ```javascript
