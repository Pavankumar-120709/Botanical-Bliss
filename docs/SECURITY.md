...
- ✅ `botanical-bliss-backend/src/main/resources/stripe.properties` - Stripe key secured
- ✅ `botanical-bliss-backend/src/main/resources/application.yml` - GitHub token secured
- ✅ `botanical-bliss-backend/src/main/resources/application-docker.yml` - All tokens secured
...
- [ ] Copy `botanical-bliss-ui/.env.example` to `botanical-bliss-ui/.env`
