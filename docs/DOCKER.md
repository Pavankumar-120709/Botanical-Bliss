# Docker Setup for Botanical Bliss

This directory contains Docker configuration files to run the entire Botanical Bliss application with nginx reverse proxy architecture.
...
```bash
# Connect to MySQL
docker-compose exec mysql mysql -u app -p botanical-bliss
...
MYSQL_DATABASE=botanical-bliss
MYSQL_USER=app
