...
import in.botanicalbliss.store.dto.CustomerDto;
import in.botanicalbliss.store.dto.CreateCustomerRequestDto;
import in.botanicalbliss.store.dto.UpdateCustomerRequestDto;
import in.botanicalbliss.store.entity.Address;
import in.botanicalbliss.store.entity.Customer;
import in.botanicalbliss.store.entity.Role;
import in.botanicalbliss.store.repository.CustomerRepository;
import in.botanicalbliss.store.repository.RoleRepository;
import in.botanicalbliss.store.service.CustomerService;
...
public class CustomerServiceImpl implements CustomerService {
    ...
    public CustomerDto createCustomer(CreateCustomerRequestDto createCustomerRequestDto) {
        ...
        customer.setClerkId("temp_" + System.currentTimeMillis()); // Temporary ID if created manually
